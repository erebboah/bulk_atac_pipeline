#!/bin/bash
#SBATCH --job-name=maptomm10    ## Name of the job
#SBATCH -A SEYEDAM_LAB            ## account to charge 
#SBATCH -p standard               ## partition/queue name
#SBATCH --nodes=1                 ## (-N) number of nodes to use
#SBATCH --array=1               ## number of tasks to launch (number of samples)
#SBATCH --cpus-per-task=16         ## number of cores the job needs
#SBATCH --output=maptomm10-%J.out ## output log file
#SBATCH --error=maptomm10-%J.err ## error log file

inpath="/share/crsp/lab/seyedam/share/newATAC/"
file=$inpath"prefixes_mm10.txt" # sample prefix file containing the names for the samples you want to process
ref="/share/crsp/lab/seyedam/share/newATAC/ref/mm10/mm10"
refM="/share/crsp/lab/seyedam/share/newATAC/ref/chrM_mm10/chrM"
