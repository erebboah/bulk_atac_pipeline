...
ref=$1 # bowtie2 reference, e.g. /share/crsp/lab/seyedam/erebboah/bulk_atac_pipeline/ref/mm10/mm10
refM=$2 # bowtie2 mitochondiral chrom reference, e.g. /share/crsp/lab/seyedam/erebboah/bulk_atac_pipeline/ref/chrM_mm10/chrM
